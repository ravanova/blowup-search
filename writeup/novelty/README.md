...
`LITERATURE_CHECK.md` is the ledger, and with four parallel legs (see `ORCHESTRATION.md` §2)
it cannot have four writers. **Each leg writes `leg_<N>.md` here**; the orchestrator adds a
one-line pointer to `LITERATURE_CHECK.md` at integration.
