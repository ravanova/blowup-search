...
`LITERATURE_CHECK.md` is the ledger, and with ten parallel legs (see `ORCHESTRATION.md` §2)
it cannot have ten writers. **Each leg writes `leg_<N>.md` here**; the orchestrator adds a
