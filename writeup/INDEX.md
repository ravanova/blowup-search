...
| `fig82` | 305 (DWM) | G | allocated at dispatch, leg live |
| `fig83` | 306 (SSE) | F | allocated at dispatch, leg live |
| `fig84` | 318 (DECR) | D | allocated at dispatch, leg live |
| `fig85` | 326 (CTRX) | E | allocated at dispatch, leg live |

Landed and no longer in flight: `fig77` (leg 314), `fig79` (leg 315), `fig80` (leg 292).
**`fig78` and `fig81` are unallocated and are the next free numbers**, then `fig86` up.
