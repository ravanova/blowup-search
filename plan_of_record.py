...
LANES = [
    ("V", "W3",         "VISCOUS RUNG -- PRIORITY LANE, ACTIVE (user ruling 2026-08-14). IT DECIDES "
                        "WHETHER ANY PATH EXISTS: W3 is the rung that settles whether Tier 3 is "
                        "reachable IN PRINCIPLE. Fill the Grade-A x fluid cell in the lowest "
                        "dimension admitting fluid structure. Leg 174: empty FOR WANT OF A TARGET, "
                        "not a method. Both branches valuable, which is what makes it cheap. C1's "
                        "naming requirement binds every unit here and is not waivable."),
    ("L", "W4, W5",     "THE LAST OBLIGATIONS -- PRIORITY LANE, ACTIVE (user ruling 2026-08-14). IT "
                        "IS ON EVERY PATH: leg 390 measured that the torus does NOT retire "
                        "CLAY_OBLIGATIONS.md sec 6(i)/(ii), so those TWO no-method obligations "
                        "(certified far-field decay with an admissible cutoff; persistence under "
                        "that localisation) are the last blockers on EVERY branch. NO UNIT IN 395 "
                        "LEGS HAS ATTACKED EITHER. Leg 381 banked the bill: critical L^3 tail "
                        "326.875 per decade, alpha > 1.5 required against alpha = 1.0 available -- "
                        "a deficit of 0.5 in a decay exponent is a NUMBER, not an impossibility."),
    ("T", "W2, W4, W6", "TORUS -- DEFERRED (user ruling 2026-08-14), demoted from priority 1 on the "
                        "lane's OWN measurement: arXiv:1902.00384, recorded as the crack in W2, is "
                        "certified by EXACTLY THE BANNED APPARATUS and both certified rows are 2D "
                        "LIFTS (leg 393 from the data package; leg 394 independently from the "
                        "prose). NOT KILLED, and NOTHING MEASURED IS SUPERSEDED -- the domain-shape "
                        "obstruction is still not refuted, NGX and leg 341 stand, W2 stands "
                        "STRENGTHENED. Kept alive only through T2'' (Type-I rigidity on T^3); T3 is "
                        "DEFERRED WITH THE LANE, NOT KILLED. RE-OPENS ON EITHER: (i) a demonstrated "
                        "genuinely-3D closure in the literature meeting W2's own pre-committed test, "
                        "its three-dimensionality supplied by the certified object itself; or (ii) "
                        "T2'' returning a rigidity picture favourable to a natively-periodic non-DSS "
                        "ansatz. Cost of deferring: OPTIONS.md sec E. Standing price, unchanged: 0 of "
                        "4 rigidity clearances carry to T^3 and the DSS ansatz does NOT survive "
                        "periodization (342 modes survive one step at lambda=1.7, 0 survive two). "
                        "Lane T does NOT retire CLAY_OBLIGATIONS.md sec 6's two obligations."),
    ("R", "W7",         "REFORMULATION FOR SCALE + SOLVER COMPETITIVENESS -- UNCHANGED 2026-08-14; "
                        "runs continuously inside EVERY unit's pre-registration. Attack the compute wall "
...
POSTURE_LIMITS = [
    ...
    "candidate that is an APPARATUS. RULED AGAIN 2026-08-14 (writeup/escalations/"
    "RULING_C1_EXEMPLAR_2026-08-14.md) after C1's exemplar arXiv:1902.00384 was measured "
    "to be certified by exactly the banned apparatus with both certified rows 2D LIFTS: "
    "C1 NEEDS NO REPLACEMENT EXEMPLAR AND STANDS EXEMPLAR-FREE -- it is an APPARATUS "
    "SCOPING and its proposition is true independent of any instance in the literature. "
    "THE SCOPE NO LONGER CARRIES ANY IMPLIED 'AND THIS HAS BEEN DEMONSTRATED': NO UNIT "
    "MAY CITE C1 AS EVIDENCE THE TECHNOLOGY CLOSES FOR ANY OBJECT CLASS. The naming "
    "requirement is UNCHANGED and binds every unit; the Conductor may not waive it. C1's "
    "transcription in the BANNED table above is BYTE-UNCHANGED by that ruling, and A2, B1 "
    "and the narrowed outreach hold are untouched.",
