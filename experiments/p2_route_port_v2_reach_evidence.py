...
def reproduce(d):
    ...
    # "The gap at rho = 10 is 63x worse than at rho = 6."  That is a ratio of the two
    # ladder rows named in the sentence, and it is checked as exactly that. (Corrected by
    # leg 60's reproduction audit from a misquoted 28x, which was actually the rho=8->10
    # factor, not rho=6->10.)
    L.check("TECH sec 2 / README", "gap at rho=10 vs rho=6", "63",
